...
содержащий полную информацию о сериалах.
То есть ваш словарь должен выглядеть примерно вот так:
...
print({key: {'Жанр': shows[key], 'Рейтинг': ratings[key]} for key in shows.keys()})